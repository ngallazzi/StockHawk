...
public class WidgetStockQuotesProvider extends AppWidgetProvider {
    public static final String TAG =  WidgetStockQuotesProvider.class.getSimpleName();
    @Override
    ...
    private void setRemoteAdapter(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(R.id.widget_list,
                new Intent(context, StockQuotesWidgetRemoteViewsService.class));
    }
